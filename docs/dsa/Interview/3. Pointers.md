...
- `str2` → **pointer** pointing to string literal. It is immutable because it points to a string literal stored in read-only memory, not because it’s a pointer.
- `sizeof`:
...
<details>
<summary>What is segmentation fault?</summary>
