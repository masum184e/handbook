...
- Calculate when best and worst case are same. If best case and worst are not same, then it doesn't have average case.
...
- Exponential - 2<sup>n</sup>, 3<sup>n</sup>, n<sup>n</sup>, n!
