...
<Columns cols={3}>
  ...
  <Card title="Basics" href="/docs/striver a2z/things to know" arrow>
    Get started with time complexity, patterns, and basic math.
  </Card>
  
  <Card title="Sorting" href="/docs/striver a2z/sorting/sorting i" arrow>
    Learn popular sorting algorithms and their time complexities.
  </Card>

  <Card title="Array (2)" href="/docs/striver a2z/array/easy" arrow>
    Learn array fundamentals, sorting, and sliding window problems.
  </Card>

  <Card title="Binary Search (12)" href="/docs/striver a2z/binary search/1d array" arrow>
