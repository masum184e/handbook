...
<Columns cols={3}>
  ...
  <Card title="Recursion & Backtracking" href="/docs/striver a2z/recursion/get a strong hold" arrow>
    Recursion basics, subsets, permutations, and backtracking problems.
  </Card>

  <Card title="Bit Manipulation" href="/docs/striver a2z/bit-manipulations/learn" arrow>
    Learn bit tricks, XOR properties, and optimization techniques.
  </Card>

  <Card title="Stack & Queue" href="/docs/striver a2z/stack/learning" arrow>
    Stack, queue, monotonic stack, and implementation problems.
  </Card>

  <Card title="Sliding Window & Two Pointer" href="/docs/striver a2z/sliding-window/medium" arrow>
    Efficient range-based problems using optimized pointers.
  </Card>

  <Card title="Heaps / Priority Queue" href="/docs/striver a2z/heaps/learning" arrow>
    Min-heap, max-heap, and top-K problems.
  </Card>

  <Card title="Greedy Algorithms" href="/docs/striver a2z/greedy/easy" arrow>
    Activity selection, interval problems, and optimization strategies.
  </Card>

  <Card title="Binary Trees" href="/docs/striver a2z/bt/traversals" arrow>
    Traversals, height, diameter, and path-based problems.
  </Card>

  <Card title="Binary Search Trees" href="/docs/striver a2z/bst/concepts" arrow>
    BST properties, insert/delete/search operations.
  </Card>

  <Card title="Graphs" href="/docs/striver a2z/graph/learning" arrow>
    BFS, DFS, shortest paths, and cycle detection.
  </Card>

  <Card title="Dynamic Programming" href="/docs/striver a2z/dp/introduction" arrow>
    Memoization, tabulation, and pattern-based DP problems.
  </Card>

  <Card title="Tries" href="/docs/striver a2z/tries/hard" arrow>
