...
1. [Assign Cookies](https://leetcode.com/problems/assign-cookies/)
   1. 12 March, 2026 ✔
      ...
      - Practice to solve it in less time
      - Keep repeating same mistake
        - Didn't sort
        - When match, iteration stack(check the failed case), because iterate twice overflow the size
...
1. [Lemonade Change](https://leetcode.com/problems/lemonade-change/description/)
   1. 12 March, 2026 ✔
      - Solved in 15 Minutes
      - Practice to solve it in less time
      - Use hashmap to optimize the solution
