...
1. [Pascal's Triangle](https://leetcode.com/problems/pascals-triangle-ii)
   ...
   - [Triangle I](https://leetcode.com/problems/pascals-triangle)
      1. 21 March, 2026: 00.13.41 ❌
         - Failed at optimization
            - Bruteforces: Time: $O(n^2)$, Space: $O(n^2)$
            - Optimal(Binomial Coeffecient: $C(n, k) = C(n, n-k)$): Time: $O(n)$, Space: $O(n)$
      2. 28 April, 2026: 00.04.25 ✔
   - [Triangle I](https://leetcode.com/problems/pascals-triangle-ii)
      1. 27 April, 2026: 00.05.47 ✔
         - Solve it within $O(n)$ time and $O(1)$ space complexity using $C(n, k) = C(n, k-1) * (n-k) / k$
2. [Majority Elements](https://leetcode.com/problems/majority-element-ii/)
