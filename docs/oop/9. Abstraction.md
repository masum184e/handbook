...
It defines <span className="danger">pure contract</span>. It doesn't have constructor or fields.
...
<summary>Can We Instantiate an Abstraction?</summary>
...
This is because abstraction defines _what must be done_, not _how it is done_.
...
<summary>Can an interface contain variables?</summary>
...
<summary>Does abstract method and interface method must need to be implmented in child class?</summary>
...
<summary>What's the differences between interface in typescript and interface in OOP</summary>

The term **“interface”** shows up in both **TypeScript** and **object-oriented programming (OOP)**, but they’re not exactly the same thing. The difference mainly comes down to _purpose_ and _how strictly they’re enforced_.
...
TypeScript interfaces _can_ describe methods too, so they sometimes **feel like OOP interfaces**, but:
