...
## Question
<details>
<summary>Why only static method can be called within static method?</summary>

In languages like **Java**, **C#**, and **C++**, a **static method belongs to the class itself**, not to any object.
Because of that, **a static method does not have access to instance data or instance methods**.
...
> Which object's `show()` should I call?
