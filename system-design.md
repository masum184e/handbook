...
## Network Security Layers in System Design
...
## Security Mechanisms in Network Design
...
## Best Practices for Network Security in System Design
...
| -------- | ---------------------------- | ----------------------------- |
| Keys     | Public/private pair          | One shared secret key         |
| Speed    | Slower                       | Faster                        |
| Use Case | Authentication, key exchange | Data encryption at scale      |
| Example  | TLS handshake, JWT, SSH      | File storage encryption, VPNs |
...
## Purpose of Hashing in System Design
...
Imagine a user visits: `https://google.com`

- Google’s server sends its digital certificate.
- The browser validates:
  - The certificate was issued by a trusted CA (e.g., GlobalSign).
  - The domain on the certificate is google.com.
  - It has not expired or been revoked.
- If all checks pass, the browser trusts the connection and shows the lock icon.
  If the certificate is invalid:
- The browser shows a warning message ("Your connection is not private").
